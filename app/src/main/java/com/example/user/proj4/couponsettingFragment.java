...
public class couponsettingFragment extends Fragment implements MyEventListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        logo = view.findViewById(R.id.samplelogo);
        loadlogo = view.findViewById(R.id.logoselect);
    ...
    public void Picker1Click(View arg0) {
        ...
        if (linear.getBackground() instanceof ColorDrawable) {
            ...
            new ColorPickerDialog(getContext(), new UpdateColor(), colorCode).show();
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PICK_IMAGE_REQUEST && resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            try {
                samplelogo = MediaStore.Images.Media.getBitmap(getContext().getContentResolver(), uri);
